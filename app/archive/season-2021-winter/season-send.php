...
<link rel="stylesheet" href="<?= SITE_DIR ?>archive/season-2021-winter/season-send.css">
</head>
      ...
      <div class="section__inner">
        <div class="section__container">
          <picture>
            ...
            <img class="send__star rotate-l" src="<?= SITE_DIR ?>archive/season-2021-winter/img/snow.png">
          </picture>
...
<script type="text/javascript" src="<?= SITE_DIR ?>archive/season-2021-winter/send.js"></script>
