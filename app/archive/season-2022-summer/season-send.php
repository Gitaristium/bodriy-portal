  ...
  <link rel="stylesheet" href="<?= SITE_DIR ?>assets/css/season-summer-2022-send.css">
  </head>
  ...
  <script type="text/javascript" src="<?= SITE_DIR ?>assets/js/season-summer-2022-send.js"></script>
