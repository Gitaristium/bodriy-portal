...
<link rel="preload" as="image" href="<?= SITE_DIR ?>archive/coffee-free/img/cup.webp">
<link rel="preload" as="image" href="<?= SITE_DIR ?>archive/coffee-free/img/question-mark.webp">
<link rel="preload" as="image" href="<?= SITE_DIR ?>archive/coffee-free/img/smile.webp">
<link rel="preload" as="image" href="<?= SITE_DIR ?>archive/coffee-free/img/smile-xx.webp">
<link rel="preload" as="image" href="<?= SITE_DIR ?>archive/coffee-free/img/ura.webp">
<link rel="preload" as="image" href="<?= SITE_DIR ?>archive/coffee-free/img/ura-black.webp">
<link rel="preload" as="image" href="<?= SITE_DIR ?>archive/coffee-free/img/ohno.webp">
...
<body>
  ...
  <div class="wrapper">
    ...
    <section class="section section-one">
      <div class="pictures-block">
        <picture>
          ...
          <img class="pictures-block__img pictures-block__img-1" src="<?= SITE_DIR ?>archive/coffee-free/img/cup.png">
        </picture>
        <picture>
          <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/cup.webp" type="image/webp">
          <img class="pictures-block__img pictures-block__img-2" src="<?= SITE_DIR ?>archive/coffee-free/img/cup.png">
        </picture>
        <picture>
          <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/cup.webp" type="image/webp">
          <img class="pictures-block__img pictures-block__img-3" src="<?= SITE_DIR ?>archive/coffee-free/img/cup.png">
        </picture>
        <picture>
          <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/cup.webp" type="image/webp">
          <img class="pictures-block__img pictures-block__img-4" src="<?= SITE_DIR ?>archive/coffee-free/img/cup.png">
        </picture>
        <picture>
          <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/cup.webp" type="image/webp">
          <img class="pictures-block__img pictures-block__img-5" src="<?= SITE_DIR ?>archive/coffee-free/img/cup.png">
        </picture>
        <picture>
          <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/cup.webp" type="image/webp">
          <img class="pictures-block__img pictures-block__img-6" src="<?= SITE_DIR ?>archive/coffee-free/img/cup.png">
        </picture>
        <picture>
          <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/cup.webp" type="image/webp">
          <img class="pictures-block__img pictures-block__img-7" src="<?= SITE_DIR ?>archive/coffee-free/img/cup.png">
        </picture>
      </div>
      <div class="container">
    ...
    <section class="section section-two">
      <div class="pictures-block">
        <picture>
          <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/smile.webp" type="image/webp">
          <img class="pictures-block__img pictures-block__img-1" src="<?= SITE_DIR ?>archive/coffee-free/img/smile.png">
        </picture>
        ...
        <picture>
          <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/smile.webp" type="image/webp">
          <img class="pictures-block__img pictures-block__img-2" src="<?= SITE_DIR ?>archive/coffee-free/img/smile.png">
        </picture>
      </div>
      ...
      <div class="play-block">
        <button class="play-button play-button--1">
          <picture>
            <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/question-mark.webp" type="image/webp">
            <img class="play-button__img" src="<?= SITE_DIR ?>archive/coffee-free/img/question-mark.png">
          </picture>

          <picture>
            <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/smile-xx.webp" type="image/webp">
            <img class="play-button__img--lose" src="<?= SITE_DIR ?>archive/coffee-free/img/smile-xx.png">
          </picture>


          <picture>
            <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/cup.webp" type="image/webp">
            <img class="play-button__img--win" src="<?= SITE_DIR ?>archive/coffee-free/img/cup.png">
          </picture>
          <picture>
      ...
      <div class="smile-block">
        <picture>
          <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/smile-look.webp" type="image/webp">
          <img class="smile-block-img" src="<?= SITE_DIR ?>archive/coffee-free/img/smile-look.png">
        </picture>
        <picture>
          <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/smile-look-eyes.webp" type="image/webp">
          <img class="smile-block-img-eyes" src="<?= SITE_DIR ?>archive/coffee-free/img/smile-look-eyes.png">
        </picture>
      </div>
    </section>
    ...
    <section class="section section-result section-result--stop">
      ...
      <picture>
        <source srcset="<?= SITE_DIR ?>archive/coffee-free/img/ohno.webp" type="image/webp">
        <img class="section-result--stop__img" src="<?= SITE_DIR ?>archive/coffee-free/img/ohno.png">
      </picture>
    </section>
