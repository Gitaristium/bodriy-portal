...
<link rel="stylesheet" href="<?= SITE_DIR ?>assets/css/loyalty.css?ver=1.7">
<script type="text/javascript">
  ...
  if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(
    ...
    ym(83929834, 'hit', '/loyalty' + search, {
      params: {}
    });
...
<script type="text/javascript" src="<?= SITE_DIR ?>assets/js/loyalty.js?ver=1.7"></script>
